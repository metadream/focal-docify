...
<head>
  ...
  <style>
  @font-face { font-family: Poppins; src: local('Poppins Light'), local('Poppins-Light'), url(//cdn.unpkg.net/assets/font/poppins-light.woff2) format('woff2'); }
  @font-face { font-family: 'JetBrains Mono'; src: local('JetBrains Mono Light'), local('JetBrains-Mono-Light'), url(//cdn.unpkg.net/assets/font/jetbrains-mono.woff2) format('woff2'); }
  * { box-sizing: border-box; }
  ...
  h1 { font-size: 30px; color: #00ad5d; }
  h2 { font-size: 24px; color:#4688f4; }
  h3 { font-size: 18px; }
  h1, h2, h3 { line-height: 1.5; margin: 20px 0 10px; }
  ...
  .menu { display: none; position: fixed; z-index: 1; top: 0; right: 15px; padding: 10px; }
  .menu svg { width: 24px; height: 24px; fill: #999; }
  .mask { display: none; position: fixed; z-index: 2; left: 0; right: 0; top: 0; bottom: 0; background: rgba(0,0,0,.3); }
  @media (max-width:640px) {
    aside { position: absolute; z-index: 3; left: -300px; transition: left .3s; }
    .menu { display: block; }
  }
  </style>
</head>
...
<aside>{{= summary }}</aside>
<main>{{= content }}</main>
<a class="menu" onclick="openSidebar()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><path d="M128 171h768v85H128v-85zm0 298h768v86H128v-86zm0 299h768v85H128v-85z"/></svg></a>
<div class="mask" onclick="closeSidebar()"></div>
